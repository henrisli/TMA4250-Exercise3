...
WANT TO DISPLAY EXP VAR AND MMAP.
...
#simulated = apply(mat,1,simulate_posterior,beta=beta,iterations=2000)
#plot_image(mat[1,])
#plot_image(mat[2,])
#plot_image(mat[3,])
#plot_image(mat[4,])
...
mtrx.melt <- melt(mtrx3d, id.vars = c("x","y"), measure.vars = "z")
ggplot(mtrx.melt, aes(x = x, y = y, z = value)) + geom_raster(aes(fill = value)) + scale_fill_gradientn(colours=color_table) + ggtitle("Variance of l binomial")

plot_image(MMAP) + ggtitle("MMAP")
