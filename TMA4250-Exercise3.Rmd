...
This means that we can simulate from the posterior distribution by using a single-site MCMC/Gibbs Simulation algorithm. We implement a version of Algorithm 9 from page 80 of 
